...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        AppController.getInstance().doGetCallback(
                "?method=chart.gettoptracks&format=json&api_key=76b686c47907e60b569a191afeb561da"
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    final TopTrackResponse topTrackResponse = AppController.getInstance().getGson().
                            fromJson(response.body().charStream(), TopTrackResponse.class);
    ...
    public void searchButtonClicked(){
        if(!isEmpty(editText)) {
            ...
            AppController.getInstance().doGetCallback(
                    "?method=track.search&format=json&api_key=76b686c47907e60b569a191afeb561da&"
                    +"track="+editText.getText().toString()).enqueue(new Callback() {
                @Override
                public void onFailure(Call call, IOException e) {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    if (response.isSuccessful()) {
                        final ResultTrackResponse resultTrackResponse = AppController.getInstance().getGson().
                                fromJson(response.body().charStream(),ResultTrackResponse.class);
